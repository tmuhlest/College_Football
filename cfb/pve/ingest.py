...
def run_ingest(seasons: list[int]) -> pd.DataFrame:
    """Full Phase 1 pipeline: pull, estimate snaps, aggregate points, apply gate.

    Writes data/processed/player_points_{season}.parquet for each season.
    Returns a combined multi-season DataFrame.
    """
